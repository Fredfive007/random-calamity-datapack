...
execute if score #crystal_active rc.task matches 1 if score #crystal_started rc.task matches 1 in minecraft:the_end if entity @e[type=minecraft:end_crystal] run scoreboard players set #crystal_seen rc.task 1
execute if score #crystal_active rc.task matches 1 if score #crystal_started rc.task matches 1 if score #crystal_seen rc.task matches 1 in minecraft:the_end unless entity @e[type=minecraft:end_crystal] run function random_event:tasks/complete/crystal
