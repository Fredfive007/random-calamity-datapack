...
scoreboard players set #stronghold_limit rc.task 48000
scoreboard players set #stronghold_tier rc.task 2
scoreboard players set #stronghold_done rc.task 0
scoreboard players set #stronghold_failed rc.task 0
tellraw @a [{"text":"[Task] ","color":"gold"},{"text":"Eye Spy selected: 40 minutes.","color":"gold"}]
