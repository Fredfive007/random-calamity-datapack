...
execute if score #pending rc.boon matches 0 if score #skull_done rc.boon matches 0 if entity @a[advancements={minecraft:nether/find_fortress=true}] run function random_event:boons/nodes/skull
